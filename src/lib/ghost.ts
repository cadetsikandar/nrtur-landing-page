...
const authors = {
  alex: { name: 'Alex Morgan', initials: 'AM', color: '#3b82f6' },
  jordan: { name: 'Jordan Kim', initials: 'JK', color: '#8b5cf6' },
  riley: { name: 'Riley Chen', initials: 'RC', color: '#10b981' },
}
