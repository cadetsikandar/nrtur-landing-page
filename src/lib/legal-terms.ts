      ...
      blocks: [
        ...
        { t: 'h3', text: 'Charges' },
        {
          ...
          items: [
            ...
            'Calling and texting are prepaid. You top up a balance and we draw from it as you send, so nothing is billed in arrears. The balance does not expire while your account is open, and it is not refundable.',
          ],
        },
        { t: 'h3', text: 'Failed payments' },
        {
          t: 'p',
          text: 'If a payment fails we will retry and email you. You keep full access for **14 days**, after which the workspace becomes read-only. It stays that way, with an export link, for **12 months** before we delete it. There is never usage to collect, because calling and texting were prepaid.',
        },
        { t: 'h3', text: 'Price changes' },
        {
          t: 'p',
          text: 'We can change our prices, but not quietly. We will give current customers at least **60 days notice** by email before a change hits your renewal, and if we raise a price you keep the price you signed up at for **12 months** from that notice. A new price never applies to a billing period you have already paid for. If you do not like the new price, cancel before it takes effect.',
        },
      ],
    },
